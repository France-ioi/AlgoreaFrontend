...
const invalidReasonSchema = z.union([
  z.literal('no_group'),
  z.literal('frozen_membership'),
  z.literal('already_member'),
  z.literal('conflicting_team_participation'),
  z.literal('team_conditions_not_met'),
]);
