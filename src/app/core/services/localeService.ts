...
export class LocaleService implements OnDestroy {
  ...
  constructor() {
    ...
    const title = appConfig.languageSpecificTitles && this.currentLang ? appConfig.languageSpecificTitles[this.currentLang.tag] : undefined;
    this.localizedTitle = title ?? appConfig.defaultTitle;
  }
