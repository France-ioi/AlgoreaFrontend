...
export const groupManagershipSchema = z.object({
  currentUserManagership: z.union([
    z.literal(managershipOpts.none),
    z.literal(managershipOpts.descendant),
    z.literal(managershipOpts.direct),
    z.literal(managershipOpts.ancestor),
  ]),
}).and(z.object({
  currentUserCanGrantGroupAccess: z.boolean(),
  currentUserCanManage: z.union([
    z.literal(managementLevelOpts.none),
    z.literal(managementLevelOpts.memberships),
    z.literal(managementLevelOpts.membershipsAndGroup),
  ]),
