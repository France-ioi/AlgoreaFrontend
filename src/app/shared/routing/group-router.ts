...
export class GroupRouter {
   ...
   */
  navigateTo(route: GroupRoute, page?: 'edit'|'details'|'details/members'): void {
   ...
   * If page is not given and we are currently on a group page, use the same page. Otherwise, default to 'details'.
   */
  url(route: GroupRoute, page?: 'edit'|'details'|'details/members'): UrlTree {
   ...
   * If page is not given and we are currently on a group page, use the same page. Otherwise, default to 'details'.
   */
  urlArray(route: GroupRoute, page?: 'edit'|'details'|'details/members'): any[] {
   ...
   */
  private currentGroupSubPage(): 'edit'|'details'|'details/members'|undefined {
    ...
    return page === 'edit' || page === 'details' || page === 'details/members' ? page : undefined;
  }
