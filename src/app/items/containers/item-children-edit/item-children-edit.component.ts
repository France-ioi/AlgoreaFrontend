...
import { isASkill, ItemType, ItemTypeCategory, itemTypeCategory } from 'src/app/items/models/item-type';
...
export class ItemChildrenEditComponent implements OnInit, OnDestroy, OnChanges {
  ...
  onDataChange(children: PossiblyInvisibleChildData[], type: Parameters<typeof itemTypeCategory>[0]): void {
    if (type === ItemTypeCategory.Skill.toString()) {
