            ...
            values: [
              {
                ...
                label: 'Nothing',
                comment: 'User(s) don\'t get any extra view access to this child, because on some extra view access they may have on the ' +
                  'chapter.'
              },
              {
                field: 'as_content_with_descendants',
                label: 'Content and descendants',
                comment: 'User(s) get this view access (but not Solutions access) on this child if they have "Content and descendants" ' +
                  'or "Solutions" access on the chapter.'
              },
              {
                field: 'as_is',
                label: 'Same as parent',
                comment: 'User(s) get the same extra access on this child, that they have on the chapter ("Content and descendants" or ' +
                  '"Solutions").'
              }
            ],
