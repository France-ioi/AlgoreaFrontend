...
interface GroupWithManagementInfo {
...
export function canCurrentUserManageMembers(group: GroupWithManagementInfo): boolean {
...
export function canCurrentUserManageGroup(group: GroupWithManagementInfo): boolean {
  if (group.current_user_can_manage) {
