...
@Component({
  selector: 'app-associated-skills',
  templateUrl: './associated-skills.component.html',
  styleUrls: ['./associated-skills.component.scss']
})
export class AssociatedSkillsComponent implements OnInit {
  ...
  suggested = [
    ...
    {
      ID: 39,
      title: 'Skill before you start notice',
      type: 'leaf',
      ring: false,
      state: 'opened',
      progress: {
